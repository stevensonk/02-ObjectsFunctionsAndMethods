...
def main():
    ...
    # better_draw_circles(rg.Point(-200,0), 11)
    even_better_draw_circles(rg.Point(100, 50), 3, 16, 'yellow', 1)
    even_better_draw_circles(rg.Point(-200, 0), 11, 9, 'green', 4)
...
def better_draw_circles(point, initial_radius):
    """
